...
- [Extra Small (Size < 576px) and Small (Size >= 576px) - success](https://assets.ccbp.in/frontend/content/react-js/coffee-planner-success-sm-output-v2.png)
- [Medium (Size >= 768px), Large (Size >= 992px) and Extra Large (Size >= 1200px)- success](https://assets.ccbp.in/frontend/content/react-js/coffee-planner-success-lg-output-v2.png)
- [Medium (Size >= 768px), Large (Size >= 992px) and Extra Large (Size >= 1200px) - error](https://assets.ccbp.in/frontend/content/react-js/coffee-planner-error-lg-output.png)
...
- The list of coffee questions is passed to the `CoffeePlanner` component as a
  prop `coffeePlannerData` in the form of an array object.
...
- The value to the property `optionsData` contains the list of question options
